...
HD_PWD='C:/Users/gaeun/Desktop/lab2_02_clock_divider/vivado/lab2_clock_divider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_clock_divider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab2_clock_divider.tcl -notrace
